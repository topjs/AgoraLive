...
import io.agora.framework.camera.VideoCaptureFactory;
...
public class CameraVideoChannel extends VideoChannel {
    ...
    CameraVideoChannel(Context context, int id) {
        super(context, id);
    }
     ...
     * @param facing io.agora.framework.camera.Constant.CAMERA_FACING_FRONT or
     *               io.agora.framework.camera.Constant.CAMERA_FACING_BACK
     */
