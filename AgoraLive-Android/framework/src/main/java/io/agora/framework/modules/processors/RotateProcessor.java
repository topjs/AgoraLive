...
import io.agora.framework.helpers.gles.RotateProgram;
...
public class RotateProcessor {
    ...
    public VideoCaptureFrame process(VideoCaptureFrame frame,
        ...
        mRotateProgram.update(desiredWidth, desiredHeight);
        ...
        frame.textureId = mRotateProgram.drawRotateFrame(
    ...
    public void release(VideoChannel.ChannelContext context) {
        if (mRotateProgram != null) mRotateProgram.destroyProgram();
    }
